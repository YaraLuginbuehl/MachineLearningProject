...
for fold_result in results:
    ...
    plt.savefig(f"/cluster/home/yluginbuehl/Denoising_2D/UNET/Model1/Model1_UNET_Image_Fold{fold}")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"/cluster/home/yluginbuehl/Denoising_2D/UNET/Model1/Model1_UNET_Loss_Fold{fold}")
