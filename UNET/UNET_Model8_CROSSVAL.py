...
for fold_result in results:
    ...
    for i, (title, img) in enumerate(zip(titles, images)):
        ...
        plt.axis("off")
    plt.tight_layout()
    plt.suptitle(f"Model 8 - Fold {fold}")
    plt.savefig(f"/cluster/home/yluginbuehl/Denoising_2D/UNET/Model8/Model8_UNET_Image_Fold{fold}")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"/cluster/home/yluginbuehl/Denoising_2D/UNET/Model8/Model8_UNET_Loss_Fold{fold}")
